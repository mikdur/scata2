...
urlpatterns = [
    ...
    path("referenceset/<int:pk>/detail", views.ReferenceSetDetailView.as_view(), name="referenceset-detail"),
    ...
    path("dataset/<int:pk>/detail/pca-tags.json", views.DataSetTagsJSONView.as_view(), name="dataset-pca-tags"),
